        ...
        <div className="viewstats">
            <div className="cards">
                ...
                <table className="table-b">
                        ...
                        <tr>
                            <td>01</td>
                            <td><img src="../images/bucket.jpg" alt=""></img></td>
                            <td>Plastic</td>
                            <td>Bucket</td>
                            <td>20 kg</td>
                        </tr>
                        <tr>
                            <td>02</td>
                            <td><img src="../images/newspapers.jpg" alt=""></img></td>
                            <td>Paper</td>
                            <td>News Papers</td>
                            <td>50 kg</td>
                        </tr>
                        <tr>
                            <td>03</td>
                            <td><img src="../images/pbag.jpg" alt=""></img></td>
                            <td>Polythene</td>
                            <td>Bags</td>
                            <td>30 kg</td>
                        </tr>
                        <tr>
                            <td>01</td>
                            <td><img src="../images/pbottle.jpg" alt=""></img></td>
                            <td>Plastic</td>
                            <td>Bottles</td>
                            <td>30 kg</td>
                        </tr>
                        <tr>
                            <td>04</td>
                            <td><img src="../images/gbottle.jpg" alt=""></img></td>
                            <td>Glass</td>
                            <td>Bottles</td>
                            <td>60 kg</td>
                        </tr>
                        <tr>
                            <td>01</td>
                            <td><img src="../images/chair.jpg" alt=""></img></td>
                            <td>Plastic</td>
                            <td>Chairs</td>
                            <td>20 kg</td>
                        </tr>
